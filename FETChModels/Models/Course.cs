...
namespace FETChModels.Models
{
    public class Course
    {
        ...
        public required string Title { get; set; }                  // Назва курсу
        public required string Subtitle { get; set; }               // Підзаголовок або короткий опис курсу
        public string? Description { get; set; }           // Детальний опис курсу
        public required string Language { get; set; }              // Мова курсу ("ua", "en" тощо)
        public bool IsFree { get; set; }                  // Чи безкоштовний курс
        [Precision(18, 2)] // Якщо значення виходить за рамки (наприклад, більше ніж 18 цифр або більше 2 знаків після коми)
        ...
        public required CourseCategory Category { get; set; }      // Категорія курсу (зовнішня модель)
